...
import lict.willow.relativelayoutexample.adapter.CustomAdapter;
import lict.willow.relativelayoutexample.database.DatabaseHelper;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        @Override
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                AlertDialog.Builder dialog = new AlertDialog.Builder(MainActivity.this);
                dialog.setTitle("Delete!").setMessage("Do you want to delete this student");
                dialog.setCancelable(false);
    ...
    public void saveData(View view) {
        ...
        if(error){
            ...
            studentArrayList.addAll(dbHelper.getAllStudent());
